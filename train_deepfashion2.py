...
from cfg_deepfashion2 import Cfg
...
class Yolo_loss(nn.Module):
    def __init__(self, n_classes=80, n_anchors=3, image_size=608, device=None, batch=2):
...
def train(model, device, config, epochs=5, batch_size=1, save_cp=True, log_step=20, img_scale=0.5):
    ...
    save_prefix = 'Yolov4_deepfashion_{}_epoch'.format(config.width)
    saved_models = deque()
    #model.train()
...
def get_args(**kwargs):
    ...
    parser.add_argument('-train_label_path', dest='train_label', type=str, default='data/deepfashion2_train.txt', help="train label path")
    parser.add_argument('-val_label_path', dest='val_label', type=str, default='data/deepfashion2_val.txt', help="train label path")
    parser.add_argument(
