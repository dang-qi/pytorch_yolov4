...
Cfg.cfgfile = os.path.join(_BASE_DIR, 'cfg', 'yolov4-coco_person.cfg')
...
Cfg.train_label = os.path.join(_BASE_DIR, 'data', 'coco_person_train.txt')
Cfg.val_label = os.path.join(_BASE_DIR, 'data' ,'coco_person_val.txt')
